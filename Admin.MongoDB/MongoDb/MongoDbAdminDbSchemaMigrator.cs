...
namespace Admin.MongoDB;

public class MongoDbAdminDbSchemaMigrator : IAdminDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbAdminDbSchemaMigrator(IServiceProvider serviceProvider)
    {
